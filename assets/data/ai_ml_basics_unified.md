...
### Q: 梯度下降的原理是什么？SGD / Adam / AdamW 有什么区别？
...
### Q: Batch Normalization 和 Layer Normalization 有什么区别？为什么 Transformer 用 LayerNorm？
...
### Q: 什么是 Precision、Recall 和 F1？什么时候分别侧重哪个？
...
### Q: 什么是 Embedding？为什么 Word2Vec 之后还需要 Contextual Embedding？
...
### Q: 什么是反向传播（Backpropagation）？为什么深度网络会有梯度消失问题？
...
### Q: 什么是 K-Means 聚类？它在 RAG/推荐系统中有哪些应用？
...
### Q: 决策树和随机森林的原理是什么？为什么 Bagging 能降低方差？
...
### Q: 什么是 ROC 曲线和 AUC？如何解读 AUC=0.85？
...
### Q: 什么是迁移学习（Transfer Learning）？Fine-tuning 和 Feature Extraction 有什么区别？
...
### Q: 什么是 RLHF 中的奖励黑客（Reward Hacking）？有哪些现实案例？
...
### Q: 什么是 Softmax 的温度缩放（Temperature Scaling）？如何用于模型校准？
